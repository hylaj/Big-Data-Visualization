...
markers = ["x", "o", "s", "*", "^", ".", "X", "D", "v", "p", "+"]
colors = ["red", "blue", "green", "brown", "orange", "cyan", "grey", "purple", "pink", "olive", "magenta", "navy"] 
...
def viz_qa(
    ...
    ax.tick_params(axis='x', labelsize=sax)
    ...
    # Showing the figure
    fig.savefig("{}.png".format(tit), dpi=fig.dpi,)
